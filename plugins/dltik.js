...
cmd({
  ...
  try {
    ...
    console.error("KAVIYA MD Error in TikTok command:", _0x56bda5);
    _0x2303a0("KAVIYA MD An error occurred while processing your request. Please try again later.");
  }
});
